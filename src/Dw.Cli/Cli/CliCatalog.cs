...
internal static class CliCatalog
{
    ...
    [
        ...
        Command("agent", "agent <context|open|config|doctor>", "Affiche le contexte ou ouvre un agent", AgentCommand.Run, ["context", "open", "config", "doctor", "show", "set-default", "--workspace", "--project", "--work-item", "--continue", "--agent", "opencode", "cursor", "claude", "codex-cli", "codex", "copilot"]),
        Command("ado", "ado <assigned|work-item|context>", "Lit Azure DevOps sans modifier", AdoCommand.Run, ["assigned", "work-item", "context", "--project", "--root", "--summary", "--comments", "--top"]),
        ...
        Command("config", "config <show|set-root|doctor>", "Valide et modifie la configuration", ConfigCommand.Run, ["show", "set-root", "doctor", "--root"]),
