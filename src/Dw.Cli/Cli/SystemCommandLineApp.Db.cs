...
internal static partial class SystemCommandLineApp
{
    private static Command Db(CommandContext context)
    {
        ...
        AddSubcommands(command,
            Subcommand("schema", "Liste les tables disponibles pour explorer rapidement une base en lecture seule.", parse => DbCommand.Schema(context, parse.GetValue<string>(OptionNames.Project), parse.GetValue<string>(OptionNames.Database), parse.GetValue<string>(OptionNames.Env)),
                [
            ...
            Subcommand("describe", "Affiche les colonnes et types d'une table pour comprendre le modele SQL.", parse => DbCommand.Describe(context, parse.GetValue<string>(OptionNames.Project), parse.GetValue<string>(OptionNames.Database), parse.GetValue<string>(OptionNames.Env), parse.GetRequiredValue<string>("table")),
                [
                    ProjectOption(context, "Projet dw."),
                    DatabaseOption(context, "Base de donnees cible."),
                    Value(OptionNames.Env, "Alias legacy de --database.")
            ...
            Subcommand("query", "Execute une requete SQL en lecture seule pour verifier ou clarifier le contexte data.", (parse, command) =>
            {
