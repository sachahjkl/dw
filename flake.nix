  ...
  outputs = {
    ...
    flake-utils.lib.eachSystem ["x86_64-linux"] (system: let
      ...
      commonArgs = {
        ...
        tags = ["timetzdata"];
        subPackages = ["cmd/dw"];
        vendorHash = "sha256-oeMrAZ8p0NqIZiIuSc+eqtW73Xz72qZfHeQh/dQFQcI=";
        env.CGO_ENABLED = "0";
      };
      ...
      formatCheck =
        pkgs.runCommand "dw-format-check" {
      ...
      architectureCheck =
        pkgs.runCommand "dw-architecture-check" {
