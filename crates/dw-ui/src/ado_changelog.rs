...
mod tests {
    ...
    fn renders_raw_markdown_table_and_html_documents() {
        ...
        assert_eq!(
            ...
            "# Changelog\n\n- [#42](https://dev.azure.com/acme/ha/_workitems/edit/42) [Bug] Actif - Corriger la sortie\n- [#43](https://dev.azure.com/acme/ha/_workitems/edit/43) [Task] Prêt - Tester \\| table"
        );
        ...
        assert_eq!(
            ...
            "<h1>Changelog</h1>\n<ul>\n  <li><a href=\"https://dev.azure.com/acme/ha/_workitems/edit/42\">#42</a> [Bug] Actif - Corriger la sortie</li>\n  <li><a href=\"https://dev.azure.com/acme/ha/_workitems/edit/43\">#43</a> [Task] Prêt - Tester \\| table</li>\n</ul>"
        );
    }
    ...
    fn renders_grouped_documents_with_parent_fallback_rows() {
        ...
        assert!(output.contains(
            "## [#100](https://dev.azure.com/acme/ha/_workitems/edit/100) [Feature] Actif - Parent"
        ));
        assert!(output.contains(
            "| [#42](https://dev.azure.com/acme/ha/_workitems/edit/42) | Bug | Actif | Child |"
        ));
        assert!(output.contains("| [#200](https://dev.azure.com/acme/ha/_workitems/edit/200) | Feature | Nouveau | Empty parent |"));
    }
