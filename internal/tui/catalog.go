...
const (
	...
	msgWorkspaces         l10n.ID = "tui.view.workspace"
	msgWork               l10n.ID = "tui.view.work"
	msgPRs                l10n.ID = "tui.view.pull-requests"
	msgData               l10n.ID = "tui.view.data"
...
var tuiEnglishEntries = []l10n.Entry{
	...
	{ID: msgWorkspaces, Text: "Workspace"},
	{ID: msgWork, Text: "Work"},
	{ID: msgPRs, Text: "Pull requests"},
	{ID: msgData, Text: "Data"},
	...
	{ID: "tui.status.draft", Text: "draft"},
	...
	{ID: "tui.status.work", Text: "Work items"},
	...
	{ID: "tui.empty.workspaces", Text: "No workspace detected."},
	{ID: "tui.empty.work", Text: "No assigned work item outside final states."},
	{ID: "tui.empty.prs", Text: "No active pull request is available."},
	{ID: "tui.empty.data", Text: "No data source is configured."},
	{ID: "tui.empty.actions", Text: "No operation is available for this filter."},
	{ID: "tui.focus.active", Text: "focused"},
	...
	{ID: "tui.column.key", Text: "Key"},
	{ID: "tui.column.description", Text: "Description"},
	{ID: "tui.column.risk", Text: "Risk"},
	...
	{ID: "tui.column.data-source", Text: "Data source"},
	{ID: "tui.column.scope", Text: "Scope"},
	{ID: "tui.column.provider", Text: "Provider"},
	...
	{ID: "tui.label.pull-requests", Text: "Active pull requests"},
	{ID: "tui.label.cleanup", Text: "Cleanup"},
	{ID: "tui.label.data-sources", Text: "Data sources"},
	...
	{ID: "tui.load.error-prefix", Text: "Load failed:"},
	{ID: "tui.load.retry", Text: "[r] retry"},
	{ID: "tui.result.complete", Text: "Operation completed successfully."},
	{ID: "tui.result.external-complete", Text: "External process completed successfully."},
	...
	{ID: "tui.help.nav-lines", Text: "Tab / Right: next view    Shift-Tab / Left: previous view    1-6: select view\nj / Down: next row    k / Up: previous row    J/K: workspace or work project\nData uses Left / Right to move focus between sources and operations."},
	{ID: "tui.help.action-lines", Text: "Enter: run selected operation    n: open composer    m: menu    ?: help\nr: generation-safe reload    /: filter operations    q: quit only from a root view    Esc: close one active layer\nUppercase actions are distinct: F executes finish, E opens state form, N opens pull request form."},
	...
	{ID: "tui.keys.work", Text: "[J/K or [/]] project  [j/k] item  [n/x] prepare/create  [e/E] state  [c] context  [w] card  [o] agent  [u] URL"},
	{ID: "tui.keys.prs", Text: "[n/x] prepare/create  [N] form  [f/F] finish  [c] changes  [d] diff  [o] agent  [u] URL"},
	{ID: "tui.keys.data", Text: "[Left/Right] focus source/operation  [j/k] select  [Enter] run  [s/d/e] catalog/describe/query"},
	{ID: "tui.keys.composer.choose", Text: "[j/k] select  [Enter] edit  [Esc] back"},
	{ID: "tui.keys.composer.edit", Text: "[Tab/Shift-Tab] field  [Left/Right/Home/End] cursor  [Ctrl+Space] suggest  [Space] type/toggle  [Enter] run  [Esc] templates"},
	...
	{ID: "tui.keys.input", Text: "[Enter] submit  [Esc] cancel  [j/k] select  [Space] toggle/type  [Left/Right/Home/End] cursor"},
	...
	{ID: "tui.small", Text: "Terminal too small. Resize to at least 50 × 14; all commands remain available after resize."},
	{ID: "tui.form.workspace-start", Text: "Create workspace"},
	{ID: "tui.form.workspace-start.desc", Text: "Create or preview a workspace from external work"},
	{ID: "tui.form.workspace-pr-start", Text: "Create workspace from pull request"},
	{ID: "tui.form.workspace-pr-start.desc", Text: "Create or preview a workspace from a pull request"},
	{ID: "tui.form.workspace-finish", Text: "Finish workspace"},
	{ID: "tui.form.workspace-finish.desc", Text: "Preview or execute workspace finish"},
	{ID: "tui.form.workspace-teardown", Text: "Remove workspace"},
	{ID: "tui.form.workspace-teardown.desc", Text: "Preview or remove a workspace"},
	{ID: "tui.form.workspace-prune", Text: "Clean workspaces"},
	{ID: "tui.form.workspace-prune.desc", Text: "Clean finished workspaces"},
	{ID: "tui.form.workspace-add-item", Text: "Add work item"},
	{ID: "tui.form.workspace-add-item.desc", Text: "Add work items to the workspace"},
	{ID: "tui.form.workspace-remove-item", Text: "Remove work item"},
	{ID: "tui.form.workspace-remove-item.desc", Text: "Remove work items from the workspace"},
	{ID: "tui.form.workspace-add-repo", Text: "Add repository"},
	{ID: "tui.form.workspace-add-repo.desc", Text: "Add a repository to the workspace"},
	{ID: "tui.form.workspace-rename", Text: "Rename workspace"},
	{ID: "tui.form.workspace-rename.desc", Text: "Rename workspace and branch"},
	{ID: "tui.form.work-list", Text: "My work items"},
	{ID: "tui.form.work-list.desc", Text: "List assigned work items with filters"},
	{ID: "tui.form.work-set-state", Text: "Move work item state"},
	{ID: "tui.form.work-set-state.desc", Text: "Move selected work items to a destination state"},
	{ID: "tui.form.data-catalog", Text: "Explore data catalog"},
	{ID: "tui.form.data-catalog.desc", Text: "List available objects from a data source"},
	{ID: "tui.form.data-describe", Text: "Describe data object"},
	{ID: "tui.form.data-describe.desc", Text: "Describe the selected object's fields"},
	{ID: "tui.form.data-query", Text: "Guided data query"},
	{ID: "tui.form.data-query.desc", Text: "Run a read-only provider query"},
	...
	{ID: "tui.field.provider", Text: "Provider"},
	...
	{ID: "tui.field.skip-provider", Text: "Skip provider"},
	...
	{ID: "tui.field.history-note", Text: "History note"},
	{ID: "tui.field.data-source", Text: "Data source"},
	{ID: "tui.field.object", Text: "Object"},
	{ID: "tui.field.query", Text: "Query"},
