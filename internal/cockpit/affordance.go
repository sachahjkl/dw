...
const (
	...
	RelationReviewScratchStart Relation = "review-scratch-start"
	RelationScratchStart       Relation = "scratch-start"
	RelationReviewPromote      Relation = "review-scratch-promotion"
	RelationPromote            Relation = "promote-scratch"
)
...
func (relation Relation) Valid() bool {
	...
	case RelationInitialize, RelationDoctor, RelationDoctorFix, RelationRefresh, RelationRefreshWork, RelationInspect, RelationOpenWorkspace,
		...
		return true
	case RelationReviewScratchStart, RelationScratchStart, RelationReviewPromote, RelationPromote:
		return true
	default:
		return false
	}
