...
var EnglishEntries = []l10n.Entry{
	...
	{ID: "guide.step.ado", Text: "Connect a work provider"},
	{ID: "guide.step.ado.detail", Text: "Provider authentication is explicit; project selection remains interactive where supported."},
	...
	{ID: "guide.step.daily.detail", Text: "Use preflight before implementation and sync to refresh task.json from the work provider."},
	...
	{ID: "guide.step.tools", Text: "Work providers, data, and AI context"},
	{ID: "guide.step.tools.detail", Text: "Data access is protected by the selected provider's read policy."},
	{ID: "guide.step.completion", Text: "Shell productivity"},
	{ID: "guide.step.completion.detail", Text: "Completions suggest options, providers, projects, repositories, workspaces, data sources, and descriptions."},
	...
	{ID: "changelog.empty.resolved", Text: "No work item resolved by the selected provider."},
	{ID: "data.column.result", Text: "Result"},
	{ID: "data.null", Text: "NULL"},
	{ID: "data.query.title", Text: "Data query"},
	{ID: "data.catalog.title", Text: "Data catalog"},
	{ID: "data.describe.title", Text: "Resource fields"},
	{ID: "data.read.title", Text: "Data rows"},
	{ID: "data.query.result", Text: "Result"},
	{ID: "data.query.rows", Text: "{count} row(s)"},
	{ID: "data.query.empty", Text: "No rows returned"},
	{ID: "data.query.truncated.badge", Text: "TRUNCATED"},
	{ID: "data.query.truncated", Text: "Result truncated; rerun with a larger row limit"},
	...
	{ID: "result.provider", Text: "Provider"},
	{ID: "result.kinds", Text: "Kinds"},
	{ID: "result.capabilities", Text: "Capabilities"},
	{ID: "result.type", Text: "Type"},
	{ID: "result.features", Text: "Features"},
	{ID: "result.capability", Text: "Capability"},
	{ID: "result.description", Text: "Description"},
	{ID: "result.next", Text: "Next"},
	{ID: "result.scope", Text: "Scope"},
	{ID: "result.connection", Text: "Connection"},
	{ID: "result.limit", Text: "Row limit"},
	{ID: "result.id", Text: "ID"},
	{ID: "result.parent", Text: "Parent"},
	{ID: "result.item-title", Text: "Title"},
	{ID: "result.branch", Text: "Branch"},
	{ID: "result.files-created", Text: "Files created"},
	{ID: "result.files-planned", Text: "Files planned"},
	{ID: "result.saved-root", Text: "Saved root"},
	{ID: "result.description-content", Text: "Description"},
